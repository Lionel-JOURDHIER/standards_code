...
<!-- Règles par langage : ne PAS les mettre ici, et ne pas les écrire à la main.
     Le sous-module en contient seize, déjà rédigées et versionnées, dans
     .claude/standards/rules/ : python, tests-python, javascript, nodejs, vba,
     ml, donnees, bdd, deploiement, securite-api, streamlit, selenium, cicd,
     http, documentation, workflow-session.
